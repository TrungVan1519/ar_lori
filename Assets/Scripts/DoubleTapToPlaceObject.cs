...
public class DoubleTapToPlaceObject : MonoBehaviour
{
    ...
    private void PlaceObject()
    {
        ...
        {
            Instantiate(ObjectToPlace.Instance.objectToPlace, placementPose.position, placementPose.rotation);
        }
    }
    ...
    private void UpdatePlacementPose()
    {
        ...
        arRaycastManager.Raycast(Camera.current.ViewportToScreenPoint(new Vector3(0.5f, 0.5f)), hits, TrackableType.Planes);
